...
\begin{itemize}
    \item What are these Generative AI/LLM things and how should we think about them? (Activity I: Think, Pair, Share)
    \item How can we \textit{currently} use these tools in useful ways? (Activity II: Asking a question of a PDF)
    \item How do I currently use these tools? (Activity III: Demonstration of github copilot)
