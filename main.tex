...
{27 September 2023 --- Resbaz Sydney 2023, University of Sydney
}
% \sectiontemplate
% {} % Image
% {} % Mask
...
\begin{itemize}
    ...
    \item Dangers and confabulations (Activity IV: Live Code Interpreter demo)
...
\begin{snugshade}
      ...
      \begin{quote}
    ... [T]he idea that patients sometimes make statements that are false or engage in behaviors that reflect false memories or beliefs, and that they do this with no deliberate intention to deceive. \parencite{Johnson2000-db}
    \end{quote}
\end{snugshade}
...
\begin{figure}
    ...
    \caption{Gartner Hype Cycle, https://en.wikipedia.org/wiki/Gartner\_hype\_cycle}
...
\begin{itemize}
    ...
    \item Load ``Navigating the Jagged Technological Frontier: Field Experimental Evidence of the Effects of AI on Knowledge 
Worker Productivity and Quality''  as a PDF in Edge
...
\begin{itemize}
    \item Does this paper involve the use of chatbots or Github Copilot?
    \item What's the jagged frontier?
\end{itemize}
}
{\purplerect{Hi Bing. Today you are going to be acting as my research assistant. My job is to prepare a presentation based on this paper. To begin, please load the pdf from the local context and tell me its title.}
\whiterect{
Hello, this is Bing. I am happy to be your research assistant today. I have loaded the pdf from the local context. Its title is: \textbf{Navigating the Jagged Technological Frontier: Field Experimental Evidence of the Effects of AI on Knowledge Worker Productivity and Quality}
}
}{https://dx.doi.org/10.2139/ssrn.4573321
}
    
% \begin{frame}{Bing Screenshot}
% \includegraphics[width=\textwidth]{Figures/bing-chat-centaur.png}    
% \end{frame}
